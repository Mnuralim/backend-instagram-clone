...
const createPost = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const file = req.file;
        if (!file)
            return next(new apiError_1.default("File not found", 400));
...
const getAllPost = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const allPosts = posts.map((post) => {
            ...
            return Object.assign(Object.assign({}, post.toObject()), { alreadyLike: alreadyLike ? true : false });
        });
        res.status(200).json({
            success: true,
            data: {
...
const getPostById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const alreadyLike = post.likedBy.find((el) => { var _a; return el._id.toString() === ((_a = req.user._id) === null || _a === void 0 ? void 0 : _a.toString()); });
        const singlePost = Object.assign(Object.assign({}, post.toObject()), { alreadyLike: alreadyLike ? true : false });
        res.status(200).json({
            success: true,
            data: {
                post: singlePost,
...
const deletePost = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const post = (yield post_1.default.findById(id));
        if (post.userId.toString() !== ((_a = req.user._id) === null || _a === void 0 ? void 0 : _a.toString()))
            return next(new apiError_1.default("You are not allowed", 401));
...
const likePost = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const isLiked = likedBy.find((data) => { var _a; return data.toString() === ((_a = req.user._id) === null || _a === void 0 ? void 0 : _a.toString()); });
        let message = "";
        if (!isLiked) {
...
const getAllLikes = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const allLikes = likes.map((like) => {
            ...
            return Object.assign(Object.assign({}, like.toObject()), { alreadyFollow: alreadyFollow ? true : false });
        });
        res.status(200).json({
            success: true,
            allLikes,
