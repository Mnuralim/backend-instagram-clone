...
describe('API auth', () => {
    ...
    beforeAll(async () => {
        try {
            await mongoose_1.default.connect(process.env.MONGO_URL_TESTING);
        }
        catch (error) {
            console.log(error);
        }
    ...
    describe('registraion route', () => {
        describe('failed registration, email already reistered', () => {
            it('should return a 400 status code', async () => {
                ...
                const { statusCode } = await supertest(app_1.default)
        ...
        describe('Success registration', () => {
            it('should return a 200 status code and success was true', async () => {
                ...
                const { statusCode, body } = await supertest(app_1.default)
                    .post('/api/v1/auths/register')
                    .send(payload);
    ...
    describe('check me route', () => {
        describe('Failed check me', () => {
            it('should return a 401 status code', async () => {
                const { statusCode, body } = await supertest(app_1.default).get('/api/v1/auths/me');
